...
public class ContaMapper {
	...
	public ContaDomainEntity toEntity(CreateContaDTO createConta) {
		...
		PropertyMap<CreateContaDTO, ContaDomainEntity> contaEntityMap = new PropertyMap<CreateContaDTO, ContaDomainEntity>() {
	...
	public void intoEntity(UpdateConta updateConta, ContaDomainEntity contaEntity) {
		...
		PropertyMap<UpdateConta, ContaDomainEntity> contaEntityMap = new PropertyMap<UpdateConta, ContaDomainEntity>() {
			protected void configure() {
				skip(destination.getId());
			}
		};
