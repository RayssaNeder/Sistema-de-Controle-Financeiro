...
public class MovimentacaoController implements MovimentacaoApi {
	...
	@PutMapping("/{uuid}")
	public ResponseEntity<MovimentacaoDTO> updateMovimentacao(@PathVariable UUID uuid,
	...
	@GetMapping
	public ResponseEntity<PageMovimentacaoDTO> listMovimentacao(@RequestParam(defaultValue = "0") Integer page,
