...
public class ContaServiceImpl implements ContaService {
	  ...
	  public ContaServiceImpl( ClienteRepository clienteRepository, ContaRepository contaRepository, ContaMapper contaMapper) {
	...
	public ContaDTO create(CreateContaDTO createConta) {
		...
		var cliente =
		        clienteRepository
		            .findByUuid(createConta.getUuidCliente())
	...
	public ContaDTO read(UUID uuid) {
		var contaEntity =
		        contaRepository
		            .findByUuid(uuid)
		            .orElseThrow(
		                () -> new ModelException(ContaService.NOT_FOUND));
