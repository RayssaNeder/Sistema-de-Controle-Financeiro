...
public interface EnderecoApi {
    ...
    @Operation(summary = "Obter endereço por UUID do cliente e do endereço",
               responses = {
    ...
    @Operation(summary = "Deletar endereço por UUID",
               responses = {
    ...
    @Operation(summary = "Listar endereços com paginação",
               responses = {
                   @ApiResponse(responseCode = "200", description = "Lista de endereços retornada com sucesso",
                                content = @Content(schema = @Schema(implementation = PageEnderecoDTO.class)))
               })
    @GetMapping
