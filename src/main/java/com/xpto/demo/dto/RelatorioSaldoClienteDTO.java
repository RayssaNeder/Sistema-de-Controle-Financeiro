...
public class RelatorioSaldoClienteDTO {
    ...
    public RelatorioSaldoClienteDTO(String nome,
    ...
    public String gerarTextoRelatorio() {
        ...
        """,
            nome,
            nome, dataCadastro,
            rua, numero, complemento != null ? complemento : "-", bairro, cidade, uf, cep,
            qtdCredito, qtdDebito, totalMovimentacoes,
            valorPago, saldoInicial, saldoAtual
        );
    }
}
